...
\vspace{10em}
    ...
    \fbox{
        \begin{minipage}{0.7\textwidth}
            Eftir áratugsfjarveru verður 26.~Nordan ráðstefnan haldin á Íslandi.
            Þetta er í fjórða skipti sem hún er haldin á Íslandi og fá nú gestir að dvelja á Hellu
